...
export const metadata = {
  ...
  description:
    '45 वर्षों के अनुभव के साथ होम्योपैथिक चिकित्सा। एड़ी व तलवे का दर्द, मस्से, गोखरू, बवासीर, बुखार तथा जटिल एवं पुरानी बीमारियों का सौम्य होम्योपैथिक उपचार। Homeopathic physician with 45 years of experience in Rampur (UP) & Gurugram.',
  openGraph: {
    title: 'डॉ. नरेश कुमार गुप्ता | होम्योपैथिक चिकित्सक',
    description:
      '45 वर्षों का अनुभव। जटिल एवं पुरानी बीमारियों का सौम्य होम्योपैथिक उपचार। रामपुर (उ.प्र.) व गुरुग्राम।',
    images: ['/og.jpg'],
    locale: 'hi_IN',
    type: 'website',
  },
