...
const fgLayers = [
  {
    depth: 16,
    globules: [
      { left: '58%', top: '73%', size: 22, dur: '9.0s', delay: '2.6s' },
      { left: '25%', top: '25%', size: 24, dur: '9.1s', delay: '1.8s' },
      { left: '24%', top: '14%', size: 22, dur: '8.2s', delay: '0.3s' },
      { left: '89%', top: '83%', size: 9, dur: '9.8s', delay: '1.2s' },
      { left: '58%', top: '85%', size: 13, dur: '9.9s', delay: '2.5s' },
      { left: '9%', top: '9%', size: 9, dur: '7.5s', delay: '0.7s' },
      { left: '4%', top: '61%', size: 18, dur: '8.9s', delay: '2.5s' },
      { left: '67%', top: '31%', size: 17, dur: '9.2s', delay: '2.0s' },
      { left: '59%', top: '85%', size: 16, dur: '8.7s', delay: '1.7s' },
      { left: '11%', top: '92%', size: 16, dur: '8.2s', delay: '0.7s' },
      { left: '37%', top: '5%', size: 10, dur: '9.6s', delay: '0.3s' },
      { left: '14%', top: '39%', size: 20, dur: '6.9s', delay: '0.1s' },
      { left: '88%', top: '2%', size: 14, dur: '7.7s', delay: '2.7s' },
      { left: '61%', top: '50%', size: 20, dur: '8.8s', delay: '1.7s' },
      { left: '26%', top: '88%', size: 16, dur: '8.4s', delay: '0.9s' },
      { left: '2%', top: '54%', size: 11, dur: '7.2s', delay: '2.1s' },
      { left: '2%', top: '9%', size: 22, dur: '10.9s', delay: '0.5s' },
      { left: '72%', top: '26%', size: 22, dur: '9.3s', delay: '3.0s' },
      { left: '17%', top: '55%', size: 20, dur: '7.1s', delay: '1.3s' },
      { left: '28%', top: '2%', size: 16, dur: '11.3s', delay: '2.9s' },
    ],
    sparkles: [
      { left: '76%', top: '40%', size: 12, dur: '3.4s', delay: '1.0s', white: false },
      { left: '78%', top: '84%', size: 21, dur: '3.2s', delay: '2.6s', white: true },
      { left: '28%', top: '58%', size: 16, dur: '3.0s', delay: '1.6s', white: false },
      { left: '38%', top: '51%', size: 13, dur: '3.1s', delay: '0.5s', white: true },
      { left: '82%', top: '33%', size: 12, dur: '4.2s', delay: '1.0s', white: false },
      { left: '59%', top: '18%', size: 21, dur: '4.0s', delay: '1.5s', white: true },
      { left: '50%', top: '25%', size: 22, dur: '3.3s', delay: '2.4s', white: false },
      { left: '79%', top: '33%', size: 15, dur: '3.3s', delay: '1.6s', white: true },
      { left: '71%', top: '27%', size: 22, dur: '4.9s', delay: '2.3s', white: false },
      { left: '78%', top: '12%', size: 18, dur: '3.1s', delay: '0.3s', white: true },
      { left: '66%', top: '34%', size: 15, dur: '4.5s', delay: '1.0s', white: false },
      { left: '54%', top: '78%', size: 19, dur: '3.6s', delay: '0.5s', white: true },
      { left: '93%', top: '10%', size: 14, dur: '3.5s', delay: '1.5s', white: false },
      { left: '79%', top: '80%', size: 13, dur: '3.6s', delay: '2.4s', white: true },
    ],
  },
  {
    depth: 34,
    globules: [
      { left: '82%', top: '16%', size: 8, dur: '10.6s', delay: '0.7s' },
      { left: '18%', top: '15%', size: 25, dur: '7.0s', delay: '1.3s' },
      { left: '4%', top: '13%', size: 14, dur: '7.8s', delay: '1.8s' },
      { left: '72%', top: '27%', size: 25, dur: '8.8s', delay: '1.3s' },
      { left: '36%', top: '2%', size: 13, dur: '10.3s', delay: '1.0s' },
      { left: '20%', top: '29%', size: 18, dur: '7.1s', delay: '1.1s' },
      { left: '46%', top: '46%', size: 16, dur: '10.9s', delay: '2.2s' },
      { left: '69%', top: '17%', size: 20, dur: '6.9s', delay: '0.9s' },
      { left: '81%', top: '81%', size: 19, dur: '9.7s', delay: '2.1s' },
      { left: '6%', top: '86%', size: 15, dur: '10.8s', delay: '3.0s' },
      { left: '30%', top: '14%', size: 20, dur: '8.0s', delay: '1.9s' },
      { left: '47%', top: '22%', size: 19, dur: '8.5s', delay: '2.0s' },
      { left: '90%', top: '89%', size: 10, dur: '9.9s', delay: '0.5s' },
      { left: '94%', top: '33%', size: 13, dur: '9.0s', delay: '0.8s' },
      { left: '82%', top: '90%', size: 25, dur: '7.7s', delay: '1.0s' },
      { left: '8%', top: '31%', size: 9, dur: '10.9s', delay: '1.2s' },
      { left: '9%', top: '29%', size: 26, dur: '11.3s', delay: '0.9s' },
      { left: '84%', top: '65%', size: 20, dur: '11.4s', delay: '1.9s' },
      { left: '19%', top: '35%', size: 12, dur: '7.9s', delay: '1.7s' },
      { left: '34%', top: '76%', size: 21, dur: '11.4s', delay: '1.2s' },
      { left: '29%', top: '19%', size: 24, dur: '9.2s', delay: '2.3s' },
      { left: '15%', top: '21%', size: 13, dur: '10.9s', delay: '1.3s' },
      { left: '9%', top: '51%', size: 20, dur: '9.8s', delay: '1.4s' },
      { left: '33%', top: '72%', size: 8, dur: '10.2s', delay: '0.3s' },
    ],
    sparkles: [
      { left: '69%', top: '36%', size: 22, dur: '3.7s', delay: '0.8s', white: false },
      { left: '21%', top: '60%', size: 12, dur: '4.9s', delay: '2.3s', white: true },
      { left: '34%', top: '66%', size: 14, dur: '4.0s', delay: '0.3s', white: false },
      { left: '81%', top: '40%', size: 22, dur: '4.0s', delay: '0.5s', white: true },
      { left: '48%', top: '22%', size: 20, dur: '4.9s', delay: '2.4s', white: false },
      { left: '1%', top: '78%', size: 17, dur: '4.0s', delay: '0.3s', white: true },
      { left: '47%', top: '41%', size: 15, dur: '3.1s', delay: '2.3s', white: false },
      { left: '11%', top: '12%', size: 19, dur: '4.6s', delay: '2.5s', white: true },
      { left: '69%', top: '18%', size: 14, dur: '4.3s', delay: '2.5s', white: false },
      { left: '22%', top: '35%', size: 20, dur: '4.7s', delay: '1.1s', white: true },
      { left: '28%', top: '71%', size: 15, dur: '4.4s', delay: '1.0s', white: false },
      { left: '86%', top: '85%', size: 17, dur: '3.9s', delay: '1.3s', white: true },
      { left: '16%', top: '33%', size: 15, dur: '3.1s', delay: '0.1s', white: false },
      { left: '71%', top: '31%', size: 21, dur: '3.4s', delay: '0.2s', white: true },
      { left: '81%', top: '9%', size: 15, dur: '3.1s', delay: '0.1s', white: false },
      { left: '43%', top: '11%', size: 20, dur: '3.5s', delay: '1.7s', white: true },
    ],
  },
];
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Yes. If you have had any tests done or are taking any medicines, please bring the reports and a list of medicines, as it helps in understanding your illness.',
        },
        {
...
const faqJsonLd = {
  ...
  '@type': 'FAQPage',
  mainEntity: T.hi.faq.items.map((f) => ({
    '@type': 'Question',
    name: f.q,
        ...
        <section className="section has-globules" id="about">
          ...
          <div className="container split">
            <div className="split-text">
              ...
              <p>{t.about.p2}</p>
              <p className="mt-20">
                <Link className="btn btn-outline" href="/doctor">
                  {t.about.more}
                </Link>
              </p>
            </div>
