...
const T = {
  hi: {
    ...
    lead: 'प्रमाणित एवं पंजीकृत होम्योपैथिक चिकित्सक · 45 वर्षों का अनुभव · रामपुर (उ.प्र.) एवं गुरुग्राम',
    bioHeading: 'एक परिचय',
    bio: [
      'डॉ. नरेश कुमार गुप्ता उत्तर प्रदेश के रामपुर नगर के जाने-माने होम्योपैथिक चिकित्सक हैं। साढ़े चार दशकों से भी लंबे अपने चिकित्सा-जीवन में उन्होंने साधारण सर्दी-बुखार से लेकर वर्षों पुरानी जटिल बीमारियों तक, हर आयु के हज़ारों रोगियों का उपचार किया है।',
    ...
    timelineHeading: 'साढ़े चार दशकों की यात्रा',
    timeline: [
      {
        year: '1980 का दशक',
  ...
  en: {
    ...
    lead: 'Certified & registered homeopathic physician · 45 years of experience · Rampur (UP) and Gurugram',
    bioHeading: 'An Introduction',
    bio: [
      'Dr. Naresh Kumar Gupta is a well-known homeopathic physician of Rampur, Uttar Pradesh. In a medical journey spanning more than four decades, he has treated thousands of patients of every age, from common colds and fevers to complex illnesses that had persisted for years.',
