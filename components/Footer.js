...
const T = {
  hi: {
    ...
    clinic: 'गुप्ता होम्योपैथिक क्लिनिक · राधा रोड, रोशन बाग़, रामपुर (उ.प्र.) · सेक्टर 14, गुरुग्राम',
    disclaimer:
  ...
  en: {
    ...
    clinic: 'Gupta Homeopathic Clinic · Radha Road, Roshan Bagh, Rampur (UP) · Sector 14, Gurugram',
    disclaimer:
